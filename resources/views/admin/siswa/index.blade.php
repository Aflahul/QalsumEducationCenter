                    ...
                    <table id="datatablesSimple" class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <td>
                                ...
                                <p class="btn btn-info btn-sm">{{ optional($s->pembayaran)->status ?? 'Belum lunas' }}
                                </p>
                            </td>
                            <td>
                                <!-- Tombol Lihat Detail -->
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 text-center">
                                                    <img src="{{ asset($s->foto) }}" alt="Foto Siswa"
                                                        class="img-fluid rounded-circle mb-3" style="max-height: 200px;">
                                                    <h4>{{ $s->nama }}</h4>
                                                </div>
                                                <div class="col-md-8">
                                                    <div class="mb-2">
