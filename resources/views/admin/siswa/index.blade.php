                            ...
                            @foreach ($siswa as $s)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <p class="btn btn-secondary  btn-sm">{{ optional($s->pendaftaran)->status ?? 'Berjalan' }}</p>
                                    </td>
                                    <td>
                                        <!-- Status bisa ditentukan berdasarkan kondisi tertentu -->
                                        <p class="btn btn-success btn-sm">{{ optional($s->pendaftaran)->status ?? 'Belum lunas' }}</p>
                                    </td>
                                    <td>
                                        <!-- Tombol Lihat Detail -->
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4 text-center">
                                                        <img src="{{ asset($s->foto) }}"
                                                            alt="Foto Siswa" class="img-fluid rounded-circle mb-3"
